...
namespace Fixed.Physics.Authoring
{
    ...
    public partial class DebugStream : SystemBase
    {
        ...
        public struct Context
        {
            ...
            internal void Point(float3 x, float size, Fixed.DebugDisplay.ColorIndex color)
            {
            ...
            internal void Cone(float3 point, float3 axis, float angle, Fixed.DebugDisplay.ColorIndex color)
            {
...
#if UNITY_EDITOR
            Fixed.DebugDisplay.DebugDisplay.Render();
#endif
        }
        ...
        protected override void OnUpdate()
        {
            ...
            if (m_DrawComponent == null)
            {
                ...
                Fixed.DebugDisplay.DebugDisplay.Instantiate();
            }
        }
...
#if UNITY_EDITOR
            Fixed.DebugDisplay.DebugDisplay.Clear();
#endif
            Dependency.Complete();
