...
public partial class ProjectIntoFutureOnCueSystem : SystemBase
{
    ...
    private float3 m_WhiteBallVelocity = sfloat.Zero;
    ...
    private sfloat GhostScale = (sfloat)0.01f;
...
public class ProjectIntoFutureOnCueAuthoring : MonoBehaviour, IReceiveEntity
{
    ...
    {
        sfloat angle = (sfloat)RotateSlider.value - (sfloat)90;
        sfloat strength = (sfloat)StrengthSlider.value;
