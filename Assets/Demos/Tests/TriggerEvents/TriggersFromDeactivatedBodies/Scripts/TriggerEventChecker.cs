    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            ...
            .ForEach((ref Entity entity, ref TriggerEventChecker component) =>
            {
                ...
                sfloat distance = math.distance(triggerBody.WorldFromBody.pos, nonTriggerBody.WorldFromBody.pos);

                Assert.IsTrue(distance < (sfloat)10.0f, "The trigger index is wrong!");
            }).Run();
