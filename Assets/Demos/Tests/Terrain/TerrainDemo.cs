...
using UnityEngine;
using TerrainCollider = Fixed.Physics.TerrainCollider;
using Collider = Fixed.Physics.Collider;
using MeshCollider = Fixed.Physics.MeshCollider;
...
public class TerrainDemoSystem : SceneCreationSystem<TerrainDemoScene>
{
    public override void CreateScene(TerrainDemoScene sceneSettings)
    {
        ...
        //             };
        //         }
        //         collider = Fixed.Physics.CompoundCollider.Create(instances);
        //         CreatedColliders.Add(collider);
        //         instances.Dispose();
        //     }
        //
