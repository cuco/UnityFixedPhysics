    ...
    public partial class VerifyCollisionEventDataSystem : SystemBase
    {
        ...
        struct VerifyCollisionEventDataJob : ICollisionEventsJob
        {
            ...
            public void Execute(CollisionEvent collisionEvent)
            {
                ...
                Assert.IsTrue(details.EstimatedImpulse >= (sfloat)0.0f);
                ...
                Assert.AreApproximatelyEqual((float)collisionEvent.Normal.x, 0.0f, 0.01f);
                Assert.AreApproximatelyEqual((float)collisionEvent.Normal.y, 1.0f, 0.01f);
                Assert.AreApproximatelyEqual((float)collisionEvent.Normal.z, 0.0f, 0.01f);
            }
        }
