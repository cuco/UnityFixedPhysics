...
namespace Fixed.Physics.Editor
{
    ...
    public class RagdollJointEditor : UnityEditor.Editor
    {
        ...
        private static void DrawCone(float3 point, float3 axis, sfloat angle, Color color)
        {
        ...
        protected virtual void OnSceneGUI()
        {
            ...
            if (drawCones)
            {
                ...
                DrawCone(pivotB, perpendicularB, math.radians(ragdoll.MinPerpendicularAngle + (sfloat)90f), Color.red);
                DrawCone(pivotB, perpendicularB, math.radians(ragdoll.MaxPerpendicularAngle + (sfloat)90f), Color.red);
            }
        }
    }
}
