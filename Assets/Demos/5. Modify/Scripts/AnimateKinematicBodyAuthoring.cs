...
partial class AnimateKinematicBodySystem : SystemBase
{
    ...
    {
        position.z = (sfloat)curve.TranslationCurve.Evaluate(t);
        orientation = quaternion.AxisAngle(math.up(), math.radians((sfloat)curve.OrientationCurve.Evaluate(t)));
    }
    ...
    protected override void OnUpdate()
    {
        ...
        var tickSpeed = (sfloat)1f / (sfloat)Time.DeltaTime;
