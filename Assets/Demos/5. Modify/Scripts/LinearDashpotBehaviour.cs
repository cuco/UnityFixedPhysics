    ...
    void IConvertGameObjectToEntity.Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        if (enabled)
        {
            ...
            var componentData = new LinearDashpot
            {
                ...
                strength = (sfloat)strength,
                damping = (sfloat)damping
            };
...
public partial class LinearDashpotSystem : SystemBase
{
    protected override void OnUpdate()
    {
        Entities
            ...
            {
                if (sfloat.Zero == dashpot.strength) return;
                ...
                impulse = math.clamp(impulse, new float3(-(sfloat)100.0f), new float3((sfloat)100.0f));
