...
#pragma warning restore 649
    ...
    void OnValidate()
    {
        LookToInterpolateFactor = Mathf.Clamp(LookToInterpolateFactor, 0f, 1f);
        LookFromInterpolateFactor = Mathf.Clamp(LookFromInterpolateFactor, 0f, 1f);
    }
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            ...
            .ForEach((Entity entity, ref CameraSmoothTrackSettings cameraSmoothTrack, in LocalToWorld localToWorld) =>
            {
                ...
                cameraSmoothTrack.OldPositionTo = HasComponent<LocalToWorld>(cameraSmoothTrack.LookTo)
                    ...
                    : localToWorld.Position + new float3(sfloat.Zero, sfloat.Zero, sfloat.One);
            }).Run();
        ...
        Entities
            ...
            .ForEach((CameraSmoothTrack monoBehaviour, ref CameraSmoothTrackSettings cameraSmoothTrack, in LocalToWorld localToWorld) =>
            {
                ...
                newPositionFrom = math.lerp(worldPosition, newPositionFrom, (sfloat)cameraSmoothTrack.LookFromInterpolateFactor);
                newPositionTo = math.lerp(cameraSmoothTrack.OldPositionTo, newPositionTo, (sfloat)cameraSmoothTrack.LookToInteroplateFactor);
