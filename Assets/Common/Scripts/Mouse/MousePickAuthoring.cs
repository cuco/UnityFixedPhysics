...
namespace Fixed.Physics.Extensions
{
    ...
    public struct MousePickCollector : ICollector<RaycastHit>
    {
        ...
        public MousePickCollector(sfloat maxFraction, NativeArray<RigidBody> rigidBodies, int numDynamicBodies)
        {
    ...
    {
        public static readonly sfloat k_MaxDistance = (sfloat)100.0f;
        ...
        struct Pick : IJob
        {
            ...
            public void Execute()
            {
                var mousePickCollector = new MousePickCollector(sfloat.One, CollisionWorld.Bodies, CollisionWorld.NumDynamicBodies);
            ...
            if (Input.GetMouseButtonDown(0) && (Camera.main != null))
            {
                ...
                Dependency = new Pick
                {
                    ...
                    RayInput = new RaycastInput
                    {
                        ...
                        End = (float3)unityRay.origin + (float3)unityRay.direction * k_MaxDistance,
                        Filter = CollisionFilter.Default,
                    },
                    Near = (sfloat)Camera.main.nearClipPlane,
        ...
        protected override void OnUpdate()
        {
            ...
            if (springData.Dragging)
            {
                ...
                float3 deltaVelocity;
                {
                    ...
                    sfloat elasticity = (sfloat)0.1f;
                    sfloat damping = (sfloat)0.5f;
                    deltaVelocity = -pointDiff * (elasticity / (sfloat)Time.DeltaTime) - damping * relativeVelocityInWorld;
                }
