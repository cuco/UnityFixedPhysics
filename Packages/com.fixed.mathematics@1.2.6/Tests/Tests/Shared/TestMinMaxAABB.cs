...
using Fixed.Mathematics.Geometry;
using Burst.Compiler.IL.Tests;

namespace Fixed.Mathematics.Tests
{
    [TestFixture]
    public class TestMinMaxAABB
    {
        ...
        public static void Transform_RigidTransform()
        {
            ...
            var aabb = Fixed.Mathematics.Geometry.Math.Transform(t, new MinMaxAABB(new float3(1.0f), new float3(3.0f)));
