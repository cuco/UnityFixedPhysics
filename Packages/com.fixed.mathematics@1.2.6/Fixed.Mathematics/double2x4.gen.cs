...
namespace Fixed.Mathematics
{
    ...
    public partial struct double2x4 : System.IEquatable<double2x4>, IFormattable
    {
        ...
        /// <summary>Constructs a double2x4 matrix from a single sfloat value by converting it to double and assigning it to every component.</summary>
        /// <param name="v">sfloat to convert to double2x4</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double2x4(sfloat v)
        {
            this.c0 = v;
            this.c1 = v;
            this.c2 = v;
        ...
        /// <summary>Implicitly converts a single sfloat value to a double2x4 matrix by converting it to double and assigning it to every component.</summary>
        /// <param name="v">sfloat to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator double2x4(sfloat v) { return new double2x4(v); }
    ...
    public static partial class math
    {
        ...
        /// <summary>Returns a double2x4 matrix constructed from a single sfloat value by converting it to double and assigning it to every component.</summary>
        /// <param name="v">sfloat to convert to double2x4</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double2x4 double2x4(sfloat v) { return new double2x4(v); }
