            ...
            while (numTriangles > 0)
            {
                ...
                switch (featureType)
                {
                    ...
                    case 1:
                    {
                        ...
                        quaternion q = Fixed.Mathematics.quaternion.AxisAngle(axis, arc / numTriangles);
                        for (int i = 0; i < featureTriangles; i++)
                        {
                    ...
                    case 2:
                    {
                        ...
                        for (int i = 0; i < featureTriangles; i++)
                        {
                            ...
                            dir = math.mul(Fixed.Mathematics.quaternion.AxisAngle(rnd.NextFloat3Direction(), rnd.NextFloat(0.0f, 0.3f)), dir);
