...
namespace Fixed.Physics
{
    ...
    public static partial class Math
    {
        ...
        public static class Constants
        {
            ...
            public static float3 MaxDisplacement3F => new float3(sfloat.MaxValue * (sfloat)0.5f);

            // Smallest sfloat such that 1.0 + eps != 1.0
            // Different from sfloat.Epsilon which is the smallest value greater than zero.
        ...
        // Note: taken from Unity.Animation/Core/MathExtensions.cs, which will be moved to Fixed.Mathematics at some point
        ...
        static float3 toEuler(quaternion q, math.RotationOrder order = math.RotationOrder.Default)
        {
            ...
            //const sfloat epsilon = 1e-6f;
            //const sfloat CUTOFF = (1.0f - 2.0f * epsilon) * (1.0f - 2.0f * epsilon);
