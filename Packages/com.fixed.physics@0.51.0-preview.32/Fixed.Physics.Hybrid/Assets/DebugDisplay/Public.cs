...
namespace Fixed.DebugDisplay
{
    ...
    internal struct Arcs : IDisposable
    {
        ...
        internal void Draw(float3 center, float3 normal, float3 arm, float angle, Fixed.DebugDisplay.ColorIndex color)
        {
    ...
    internal struct Cones : IDisposable
    {
        ...
        internal void Draw(float3 point, float3 axis, float angle, Fixed.DebugDisplay.ColorIndex color)
        {
            float3 dir;
    ...
    {
        internal static void Draw(float3 point, float3 axis, float angle, Fixed.DebugDisplay.ColorIndex color)
        {
