        ...
        protected override void OnUpdate()
        {
            ...
            unsafe
            {
                ...
                *sharedOutput = m_DebugStreamSystem.GetContext(1);
                ...
                // This will call the extension method defined in Fixed.Physics
...
#pragma warning restore 618
        ...
        private unsafe struct DisplayCollisionEventsJob : ICollisionEventsJobBase
        {
            ...
            public unsafe void Execute(CollisionEvent collisionEvent)
            {
                ...
                {
                    case 1:
                        color = Fixed.DebugDisplay.ColorIndex.Blue;
                        break;
                    case 2:
                        color = Fixed.DebugDisplay.ColorIndex.Cyan;
                        break;
                    default:
                        color = Fixed.DebugDisplay.ColorIndex.Magenta;
                        break;
                }
